...
echo:                                                          
echo:                                       
echo:          [1] Reset IDM Activation [30 DAYS]
echo:          _____________________________________________   
echo:                                                          
call :_color2 %_White% "          [2] Windows Firewall Status:  " %_col% "[%_status%]"
echo:          _____________________________________________   
echo:                                                                                         
echo:          [3] Exit                                        
echo:       ___________________________________________________
echo:   
call :_color2 %_White% "        " %Red% "Enter a menu option in the Keyboard [1,2,3]"
choice /C:123456 /N
set _erl=%errorlevel%

if %_erl%==3 exit /b
if %_erl%==2 call :_tog_Firewall&goto MainMenu
